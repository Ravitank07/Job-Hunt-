...
const CardList = () => {
    ...
    const cardData = [
        // Page 1 Data
        {
            title: "Backend Node.js Developer Internship",
            price: "₹ 4000 - ₹ 20000",
            tabItems: [
                { id: 1, text: "Proficient in JavaScript and Node.js" },
                { id: 2, text: "Experience with Express.js Framework" },
                { id: 3, text: "Knowledge of RESTful API Design" },
                { id: 4, text: "Familiarity with MongoDB or SQL Databases" },
                { id: 5, text: "Excellent Communication Skills" },
                { id: 6, text: "Debugging and Problem-Solving Skills" },
                { id: 7, text: "Understanding of Asynchronous Programming" },
                { id: 8, text: "Ability to Work Independently" },
                ...
                { id: 13, text: "Hands-On Node.js Projects" },
                { id: 14, text: "Flexible Working Hours" },
