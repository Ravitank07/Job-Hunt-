...
const CardList = () => {
    ...
    const cardData = [
        ...
        // Card 1
        {
            ...
            price: "₹ 4000 - ₹ 20000",
            tabItems: [
                { id: 1, text: "Experience with Laravel Framework" },
                { id: 2, text: "Proficient in PHP and MySQL" },
                { id: 3, text: "Familiarity with MVC Architecture" },
                { id: 4, text: "Knowledge of RESTful APIs" },
                { id: 5, text: "Strong Understanding of OOP Concepts" },
                { id: 6, text: "Ability to Write Clean, Scalable Code" },
                { id: 7, text: "Version Control (e.g., Git)" },
                { id: 8, text: "Debugging and Problem-Solving Skills" },
                ...
                { id: 13, text: "Hands-On Laravel Projects" },
